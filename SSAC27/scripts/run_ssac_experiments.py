"""Regenerate every number in SSAC27/results/ in one command.
    ...
    python SSAC27/scripts/run_ssac_experiments.py            # all tasks
    python SSAC27/scripts/run_ssac_experiments.py --task 1   # one task
...
the published Finding 2 numbers exactly. Task 6 rebuilds the cohort from the raw
