# Arm C — Named player reasoning (v2)
...
Set `comparables` to null unless you can provide specific historical player-season IDs in exact `Name (YYYY)` format. Never place archetype descriptions in `comparables`.
